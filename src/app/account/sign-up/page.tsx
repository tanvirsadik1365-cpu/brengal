...
export default function SignUpPage() {
  return (
    <main className="bg-[#F5F2EC] px-4 py-12 text-[#121212] sm:px-6 lg:px-8 lg:py-16">
      <section className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.92fr_520px] lg:items-center">
        <div>
          <p className="inline-flex rounded-full border border-[#E3D7C5] bg-[#FFFCF7] px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[#A97912]">
            Customer account
          </p>
